...
$cmd workspace init --workspace tapstate --jira-user dev@example.com --jira-project TAP | grep '"profile":'
...
$cmd feedback report --workspace tapstate --date 2026-07-21 | grep '"runs":7'
