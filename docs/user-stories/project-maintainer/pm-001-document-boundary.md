...
4. Jira Description 记录任务拆解、验证命令和剩余工作，Comment 记录当前状态、阻塞与验收结果。
...
- 如果设计文档混入实施进度，将其迁移到 Jira 对应工作项。
- 如果 Jira 计划改变稳定能力边界，同步更新设计或明确需要用户决策。
- 如果故事线缺少验收口径，不能进入设计调整。

### 验收标准

- 故事线、设计、计划和实现状态没有混写。
- 审阅者能从故事线追溯到设计，再追溯到 Jira 计划和验收命令。
