...
```json
{
  ...
  "agentic_next_action": {
    "executor": "ai",
    "action": "assess_repository_branch_mapping",
    "operation_id": "repository_branch_assess",
    "command_argv": ["task", "repositories", "assess", "--issue-key", "TAP-123"],
    "command_line": "ao-work task repositories assess --issue-key TAP-123",
