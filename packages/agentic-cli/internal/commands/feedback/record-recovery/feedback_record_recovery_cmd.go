...
func Register(registry *cmdkit.Registry) {
	registry.MustRegister(cmdkit.CommandSpec{
		...
		Usage:     "agentic-cli feedback record-recovery --workspace <name> --run-id <id> --original-operation <operation> --original-code <code> --evidence-file <path> --external-reference <ref> --readback-verified=true --remote-write-completed=true|false --retry-safe=true|false --confirm-recovery-record",
