...
| 问题版本 | `problem_version` | Jira 影响版本 fields.versions（多选） | 4.18.0、4.21.0 | 保留 Jira 初始影响版本；用户通过 issue-versions 的 effective.versions/proof 确认本地正确版本，execution_branch 独立确认并核验实际 Git 分支。版本名称不映射分支；同步差异不阻止本地流程。 |
