...
class CiObservationTest(unittest.TestCase):
    ...
    def test_configured_ci_must_start_within_five_minutes(self) -> None:
        ...
        self.assertEqual("decision", timed_out["next_step"]["kind"])
        self.assertEqual("analyze_ci_timeout", timed_out["next_step"]["action"])
    ...
    def test_failed_runner_log_is_redacted_and_required_before_report_parse(self) -> None:
        ...
        self.assertEqual("parse_ci_report", runner_log["next_step"]["action"])
